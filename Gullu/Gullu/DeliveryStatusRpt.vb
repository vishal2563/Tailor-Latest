...
Public Class DeliveryStatusRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gullu.DeliveryStatusRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeliveryStatusRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeliveryStatusRpt = New DeliveryStatusRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
